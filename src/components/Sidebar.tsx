...
export function Sidebar({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex w-64 shrink-0 flex-col border-r border-slate-200 bg-white transition-transform duration-200 dark:border-slate-800 dark:bg-slate-900 md:translate-x-0 md:transition-[width] ${
      ...
      >
        ...
        >
          ...
          <button
            ...
            title="Settings"
            aria-label="Settings"
            className={`ml-auto rounded-lg p-2 text-slate-500 transition-colors hover:bg-slate-100 hover:text-slate-900 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-slate-100 ${
              collapsed ? 'md:hidden' : ''
            }`}
          >
            <svg

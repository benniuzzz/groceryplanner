...
export function SettingsView() {
  ...
  return (
    <section>
      <h2 className="text-lg font-semibold text-slate-900">Item names</h2>
      ...
      <div className="mt-4 flex flex-wrap items-end gap-2">
        <label className="flex flex-1 min-w-[200px] flex-col gap-1">
          <span className="text-xs font-medium text-slate-500">New item name</span>
          <input
            className={inputCls}
...
function AllowedItemRow({
  ...
  return (
    <li className="flex flex-wrap items-center gap-2 rounded-xl border border-slate-200 bg-white p-3">
      <input
